Note: The search filter doesn't work due to the the data being placed in one table row. Consequently, there is no way for channels to be filtered because all objects are placed under the same row. 
